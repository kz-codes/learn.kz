...
The 'demo1' project was generated by using the default-python template.

- `src/`: Python source code for this project.
  - `src/demo1/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
   ...
   `[dev yourname] demo1_etl` to your workspace.
